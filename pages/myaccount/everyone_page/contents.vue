    ...
    <div id="everyone">
        ...
        <div class="set_pop" v-show="show_detail">
            ...
            <div class="list_detail detail" v-else>
                <p @click="deleteOrTell('post_report')" v-if="$route.query.who === 'everyone'">…</p>
        ...
        <div class="everyone_list_my_name"  v-show="!show_detail" v-if="$route.query.who === 'everyone'">
...
export default class everyone extends Vue {
    ...
    addComment() {
        ...
        if(this.$route.query.who !== "everyone" && this.my_icon !== 'not') {
